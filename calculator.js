...
const page = pageconfig.getPage();
const yourdetails = require('./yourdetails.js');
console.log(page);

// Immediately Invoked Async Arrow Function:

(async () => {
    await yourdetails.numberOfDependants(page);
})();
// Immediately Invoked Async Function Expression:

// (async function () {
//     console.log(await "hello2");
// })();

// (async function() { await yourdetails.numberOfDependants(page); } );
// import { applicationType, numberOfDependants, propertyType } from './yourdetails.js'
